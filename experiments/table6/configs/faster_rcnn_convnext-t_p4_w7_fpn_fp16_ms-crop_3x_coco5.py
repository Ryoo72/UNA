...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/home/ubuntu/workspace/mmdetection/noise_controller/newmixnoisy5key_instances_train2017.json',
...
work_dir = './work_dirs/faster_rcnn_convnext-t_p4_w7_fpn_fp16_ms-crop_3x_coco5'
auto_resume = False
gpu_ids = range(0, 8)
