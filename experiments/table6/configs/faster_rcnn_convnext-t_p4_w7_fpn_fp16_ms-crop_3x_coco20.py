...
log_level = 'INFO'
load_from = None
resume_from = '/home/ubuntu/workspace/mmdetection/work_dirs/faster_rcnn_convnext-t_p4_w7_fpn_fp16_ms-crop_3x_coco20/epoch_8.pth'
workflow = [('train', 1)]
...
work_dir = './work_dirs/faster_rcnn_convnext-t_p4_w7_fpn_fp16_ms-crop_3x_coco20'
auto_resume = False
gpu_ids = range(0, 8)
